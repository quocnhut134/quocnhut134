# Hi there, I'm Duong Quoc Nhut

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=25&pause=1000&color=2E91FC&center=false&vCenter=false&width=500&lines=AI+Engineer;Computer+Vision;Natural+Language+Processing;Junior+at+UIT+(VNU-HCM);)](https://git.io/typing-svg)
...
* I’m currently working on **Handwritten Text Recognition, Person Re-Identification, GenAI and LLM Fine-tuning**.
...
Here are some of my key projects in Computer Vision (CV) and NLP:
